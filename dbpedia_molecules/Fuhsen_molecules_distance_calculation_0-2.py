...
#molecules_pairs_file = open("TransE_results_0-2.txt", 'r')
#molecules_pairs_file = open("Dump0_Dump2_ALLvsALL_20000_random_samples.txt", 'r')
molecules_pairs_file = open("TransE_500x500_0-2.txt", 'r')
molecules_pairs = molecules_pairs_file.readlines()
molecules_pairs_file.close()

print len(molecules_pairs)

results_distances = open('500_vs_500_TransE_results_20161110_0-2.txt', 'w')
